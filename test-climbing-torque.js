// Test script for climbing scenario with significant flight path angle
...
// Set up test configuration for CLIMBING scenario
physics.setTestConfiguration(10000, 250); // 10,000 ft, 250 KTS (lower altitude for more significant climb)

// Set up initial conditions for climbing
const input = {
  pitch: 0.1, // Slight nose-up pitch for climbing
  roll: 0,
  yaw: 0,
  throttle: 0.9 // Higher throttle for climb
};

// Simulate a climbing scenario where we should see more significant drag torque
console.log("🧪 TESTING CLIMBING SCENARIO WITH DRAG TORQUE");
console.log("==============================================");
