// Boeing 777-300ER overhead panel — stub
import React from 'react';

const OverheadPanelB77W = ({ flightState, onSystemAction }) => (
  <div style={{ display:'flex', alignItems:'center', justifyContent:'center', height:'100%', color:'#666', fontSize:'14px', fontFamily:'monospace' }}>
    <div style={{ textAlign:'center' }}>
      <div style={{ fontSize:'11px', color:'#444', marginBottom:'8px' }}>Boeing 777-300ER</div>
...
export default OverheadPanelB77W;
