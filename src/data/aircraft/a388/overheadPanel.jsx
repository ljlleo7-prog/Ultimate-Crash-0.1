// Airbus A380-800 overhead panel — stub
import React from 'react';

const OverheadPanelA388 = ({ flightState, onSystemAction }) => (
  <div style={{ display:'flex', alignItems:'center', justifyContent:'center', height:'100%', color:'#666', fontSize:'14px', fontFamily:'monospace' }}>
    <div style={{ textAlign:'center' }}>
      <div style={{ fontSize:'11px', color:'#444', marginBottom:'8px' }}>Airbus A380-800</div>
...
export default OverheadPanelA388;
