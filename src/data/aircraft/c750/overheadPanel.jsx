// Cessna Citation X overhead panel — stub
import React from 'react';

const OverheadPanelC750 = ({ flightState, onSystemAction }) => (
  <div style={{ display:'flex', alignItems:'center', justifyContent:'center', height:'100%', color:'#666', fontSize:'14px', fontFamily:'monospace' }}>
    <div style={{ textAlign:'center' }}>
      <div style={{ fontSize:'11px', color:'#444', marginBottom:'8px' }}>Cessna Citation X</div>
...
export default OverheadPanelC750;
